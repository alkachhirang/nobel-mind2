...
const Header = () => {
  ...
  return (
    <div className='lg:bg-Bghero max-w-[1440px] mx-auto bg-cover bg-top bg-no-repeat sm:h-[560px] lg:h-[810px] relative'>
      <Image src={triangleimg} alt="triangleimg" className='absolute left-[2%] bottom-[-4%] lg:bottom-[3%] w-full max-w-[40px] sm:max-w-[70px]' />
      ...
      <div className='container xl:max-w-[1164px] mx-auto px-3 relative z-[2]'>
        <div className='py-[19px] flex justify-between items-center'>
          ...
          >
            <li><Link onClick={() => setNav(!nav)} href={'#home'} className='font-normal text-[16px] leading-[100%] text-[#131200] opacity-[70%] hover:opacity-[100%] transition-all duration-300 ease-linear after:absolute relative after:w-[0] after:h-[1.3px] after:bg-[#131200] after:left-[50%] hover:after:left-0 after:bottom-[-3px] after:rounded-[5px] hover:after:w-full after:transition-all after:duration-300 after:ease-linear '>Home</Link></li>
            <li><Link onClick={() => setNav(!nav)} href={'#About'} className='font-normal text-[16px] leading-[100%] text-[#131200] opacity-[70%] hover:opacity-[100%] transition-all duration-300 ease-linear after:absolute relative after:w-[0] after:h-[1.3px] after:bg-[#131200] after:left-[50%] hover:after:left-0 after:bottom-[-3px] after:rounded-[5px] hover:after:w-full after:transition-all after:duration-300 after:ease-linear '>About Us</Link></li>
            <li><Link onClick={() => setNav(!nav)} href={'#Services'} className='font-normal text-[16px] leading-[100%] text-[#131200] opacity-[70%] hover:opacity-[100%] transition-all duration-300 ease-linear after:absolute relative after:w-[0] after:h-[1.3px] after:bg-[#131200] after:left-[50%] hover:after:left-0 after:bottom-[-3px] after:rounded-[5px] hover:after:w-full after:transition-all after:duration-300 after:ease-linear '>Services</Link></li>
            <li><Link onClick={() => setNav(!nav)} href={'#WhyChooseUs'} className='font-normal text-[16px] leading-[100%] text-[#131200] opacity-[70%] hover:opacity-[100%] transition-all duration-300 ease-linear after:absolute relative after:w-[0] after:h-[1.3px] after:bg-[#131200] after:left-[50%] hover:after:left-0 after:bottom-[-3px] after:rounded-[5px] hover:after:w-full after:transition-all after:duration-300 after:ease-linear text-nowrap '>Why Choose Us</Link></li>
            <li><Link onClick={() => setNav(!nav)} href={'#Blogs'} className='font-normal text-[16px] leading-[100%] text-[#131200] opacity-[70%] hover:opacity-[100%] transition-all duration-300 ease-linear after:absolute relative after:w-[0] after:h-[1.3px] after:bg-[#131200] after:left-[50%] hover:after:left-0 after:bottom-[-3px] after:rounded-[5px] hover:after:w-full after:transition-all after:duration-300 after:ease-linear '>Blogs</Link></li>
            <li><Link onClick={() => setNav(!nav)} href={'#FAQ'} className='font-normal text-[16px] leading-[100%] text-[#131200] opacity-[70%] hover:opacity-[100%] transition-all duration-300 ease-linear after:absolute relative after:w-[0] after:h-[1.3px] after:bg-[#131200] after:left-[50%] hover:after:left-0 after:bottom-[-3px] after:rounded-[5px] hover:after:w-full after:transition-all after:duration-300 after:ease-linear '>FAQ</Link></li>
