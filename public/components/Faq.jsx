    ...
    return (
        <div className='xl:pt-[150px] lg:pt-[90px] md:pt-[70px] sm:pt-[50px] pt-[40px] xl:pb-[90px] lg:pb-[50px] sm:pb-[50px] pb-[40px] relative'>
            ...
            <div id='FAQ' className='container mx-auto xl:max-w-[1164px] px-3'>
                ...
                <div className="flex flex-col w-full gap-[18px] max-w-[814px] mx-auto overflow-hidden px-5 sm:py-[50px] py-[30px]" data-aos="zoom-in-up">
                    <Accordion open={open === 1} className={`${open === 1 ? "border border-b-[6px] border-[#A854E9]" : "border-[#A854E933] border"}  border-solid  rounded-md sm:p-[22.5px] p-[15px] shadow-[0px_4px_32px_0px_#00000014]`}>
                        <AccordionHeader onClick={() => handleOpen(1)} className="p-0 flex acc1 justify-between w-full items-center border-none"><p className="ff_outfit text-start sm:text-[16px] font-semibold text-[#000000] leading-[150%] ">What is Artificial Intelligence (AI)?</p> <div className={`${open === 1 ? "rotate-180" : ""} transition-all ease-linear duration-200`}><AccBtn /></div></AccordionHeader>
                        <AccordionBody className="pe-10 mt-3 text-[16px] font-normal leading-[150%] opacity-70 text-[#000000]">
                    ...
                    <Accordion open={open === 2} className={`${open === 2 ? "border border-b-[6px] border-[#A854E9]" : "border-[#A854E933] border"}  border-solid  rounded-md sm:p-[22.5px] p-[15px] shadow-[0px_4px_32px_0px_#00000014]`}>
                        <AccordionHeader onClick={() => handleOpen(2)} className="p-0 flex acc1 justify-between w-full items-center border-none"><p className="ff_outfit text-start text-[14px] sm:text-[16px] font-semibold text-[#000000] leading-[150%] ">How does AI benefit our company?</p> <div className={`${open === 2 ? "rotate-180" : ""} transition-all ease-linear duration-200`}><AccBtn /></div></AccordionHeader>
                        <AccordionBody className="pe-10 mt-3 text-[16px] font-normal leading-[150%] opacity-70 text-[#000000]">
                            Artificial Intelligence refers to the development of computer systems that can perform tasks that typically require human intelligence. These tasks include learning, reasoning, problem-solving, perception, and language understanding.
                        </AccordionBody>
                    </Accordion>
                    <Accordion open={open === 3} className={`${open === 3 ? "border border-b-[6px] border-[#A854E9]" : "border-[#A854E933] border"}  border-solid  rounded-md sm:p-[22.5px] p-[15px] shadow-[0px_4px_32px_0px_#00000014]`}>
                        <AccordionHeader onClick={() => handleOpen(3)} className="p-0 flex acc1 justify-between w-full items-center border-none"><p className="ff_outfit text-start text-[14px] sm:text-[16px] font-semibold text-[#000000] leading-[150%] ">What types of AI technologies are relevant to our industry?</p> <div className={`${open === 3 ? "rotate-180" : ""} transition-all ease-linear duration-200`}><AccBtn /></div></AccordionHeader>
                        <AccordionBody className="pe-10 mt-3 text-[16px] font-normal leading-[150%] opacity-70 text-[#000000]">
                            Artificial Intelligence refers to the development of computer systems that can perform tasks that typically require human intelligence. These tasks include learning, reasoning, problem-solving, perception, and language understanding.
                        </AccordionBody>
                    </Accordion>
                    <Accordion open={open === 4} className={`${open === 4 ? "border border-b-[6px] border-[#A854E9]" : "border-[#A854E933] border"}  border-solid  rounded-md sm:p-[22.5px] p-[15px] shadow-[0px_4px_32px_0px_#00000014]`}>
                        <AccordionHeader onClick={() => handleOpen(4)} className="p-0 flex acc1 justify-between w-full items-center border-none"><p className="ff_outfit text-start text-[14px] sm:text-[16px] font-semibold text-[#000000] leading-[150%] ">How can our employees adapt to AI integration?</p> <div className={`${open === 4 ? "rotate-180" : ""} transition-all ease-linear duration-200`}><AccBtn /></div></AccordionHeader>
                        <AccordionBody className="pe-10 mt-3 text-[16px] font-normal leading-[150%] opacity-70 text-[#000000]">
                            Artificial Intelligence refers to the development of computer systems that can perform tasks that typically require human intelligence. These tasks include learning, reasoning, problem-solving, perception, and language understanding.
                        </AccordionBody>
                    </Accordion>
                    <Accordion open={open === 5} className={`${open === 5 ? "border border-b-[6px] border-[#A854E9]" : "border-[#A854E933] border"}  border-solid  rounded-md sm:p-[22.5px] p-[15px] shadow-[0px_4px_32px_0px_#00000014]`}>
                        <AccordionHeader onClick={() => handleOpen(5)} className="p-0 flex acc1 justify-between w-full items-center border-none"><p className="ff_outfit text-start text-[14px] sm:text-[16px] font-semibold text-[#000000] leading-[150%] ">How can our company ensure data security with AI?</p> <div className={`${open === 5 ? "rotate-180" : ""} transition-all ease-linear duration-200`}><AccBtn /></div></AccordionHeader>
                        <AccordionBody className="pe-10 mt-3 text-[16px] font-normal leading-[150%] opacity-70 text-[#000000]">
                            Artificial Intelligence refers to the development of computer systems that can perform tasks that typically require human intelligence. These tasks include learning, reasoning, problem-solving, perception, and language understanding.
                        </AccordionBody>
                    </Accordion>
