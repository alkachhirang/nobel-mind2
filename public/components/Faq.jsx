...
const Faq = () => {
    ...
    return (
        <div className='xl:pt-[150px] lg:pt-[90px] md:pt-[60px] pt-[50px] xl:pb-[80px] lg:pb-[70px] pb-[40px] relative'>
            ...
            <div id='FAQ' className='container mx-auto xl:max-w-[1164px] px-3'>
                ...
                <div className="flex flex-col w-full gap-[18px] max-w-[740px] mx-auto overflow-hidden mt-[30px] lg:mt-[52px]" data-aos="zoom-in-up">
                    <Accordion open={open === 1} className={`${open === 1 ? "border border-b-[6px] border-[#A854E9]" : "border-[#A854E933] border"}  border-solid  rounded-md p-6`}>
                    ...
                    <Accordion open={open === 2} className={`${open === 2 ? "border border-b-[6px] border-[#A854E9]" : "border-[#A854E933] border"}  border-solid  rounded-md p-6`}>
                    ...
                    <Accordion open={open === 3} className={`${open === 3 ? "border border-b-[6px] border-[#A854E9]" : "border-[#A854E933] border"}  border-solid  rounded-md p-6`}>
                    ...
                    <Accordion open={open === 4} className={`${open === 4 ? "border border-b-[6px] border-[#A854E9]" : "border-[#A854E933] border"}  border-solid  rounded-md p-6`}>
                    ...
                    <Accordion open={open === 5} className={`${open === 5 ? "border border-b-[6px] border-[#A854E9]" : "border-[#A854E933] border"}  border-solid  rounded-md p-6`}>
